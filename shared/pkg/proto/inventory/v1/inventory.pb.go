...
func (x *Part) GetStringValue() string {
	if x != nil {
		if x, ok := x.Metadata.(*Part_StringValue); ok {
...
func (x *Part) GetInt64Value() int64 {
	if x != nil {
		if x, ok := x.Metadata.(*Part_Int64Value); ok {
			return x.Int64Value
		}
	}
	return 0
...
func (x *Part) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.Metadata.(*Part_DoubleValue); ok {
...
func (x *Part) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Metadata.(*Part_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts\"\xdf\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\n" +
	"bool_value\x18\r \x01(\bH\x00R\tboolValue\x129\n" +
	"\n" +
	...
	"\awebsite\x18\x03 \x01(\tR\awebsite\"\xbc\x01\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBHZFgithub.com/Sundallik/microservices/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	8,  // 1: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	...
	9,  // 6: inventory.v1.Part.created_at:type_name -> google.protobuf.Timestamp
	9,  // 7: inventory.v1.Part.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 8: inventory.v1.PartsFilter.categories:type_name -> inventory.v1.Category
	1,  // 9: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	3,  // 10: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	2,  // 11: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	4,  // 12: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
...
func file_inventory_v1_inventory_proto_init() {
	...
	file_inventory_v1_inventory_proto_msgTypes[4].OneofWrappers = []any{
		(*Part_StringValue)(nil),
		(*Part_Int64Value)(nil),
		(*Part_DoubleValue)(nil),
		(*Part_BoolValue)(nil),
	}
	type x struct{}
